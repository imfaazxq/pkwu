      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start justify-center">
            <div className="mb-6">
              <h2 className="rozha-one text-3xl font-bold text-[#0A3910]">buijatotok</h2>
            </div>
            <div className="flex space-x-4">
              ...
              {[
                ...
                <a 
                  key={index} 
                  href={social.href} 
                  className="rounded-full w-8 h-8 bg-[#0A3910] flex items-center justify-center"
                >
                  <svg 
                    width="18" 
                    height="18" 
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="montserrat text-md font-semibold mb-4 text-[#0A3910] uppercase">QUICK LINK</h3>
              ...
              {[
                ...
                <li key={index}>
                  <a 
                    ...
                    className="montserrat text-gray-600 text-[#0A3910] flex items-center justify-center md:justify-start"
                  >
          ...
          {/* Contact Info */}
          <div className="flex flex-col items-center md:items-start">
            <h3 className="montserrat text-md font-semibold mb-4 text-[#0A3910] uppercase">CONTACT INFO</h3>
            <ul className="space-y-3 text-center md:text-left">
              <li className="flex items-start justify-center md:justify-start">
                <svg 
                  className="w-5 h-5 text-[#0A3910] mt-1 mr-2" 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24" 
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="montserrat text-[#0A3910]">
                  Btn. Sukma Bumi Gowa<br />Permai, Gowa
                </p>
              </li>
              <li className="flex items-center justify-center md:justify-start">
                <svg 
                  className="w-5 h-5 text-[#0A3910] mr-2" 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24" 
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="montserrat text-[#0A3910]">+62 8539 9086 505</p>
              </li>
              <li className="flex items-center justify-center md:justify-start">
                <svg 
                  className="w-5 h-5 text-[#0A3910] mr-2" 
                ...
                <p className="montserrat text-[#0A3910]">halijahst14@gmail.com</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-black text-center">
          <p className="montserrat text-[#0A3910]">© 2025 Copyright: Buijatotok.Com</p>
        </div>
      </div>
    </footer>
    </div>
